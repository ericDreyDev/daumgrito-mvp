...
class _AuthScreenState extends State<AuthScreen> {
    ...
    try {
      ...
      if (!_isLogin && result.user.userType == UserType.provider) {
        await widget.apiClient.put('/providers/profile', {
          ...
          'selfieUrl': '',
          'baseAddress':
              '${_neighborhoodController.text.trim()}, ${_cityController.text.trim()}',
          'serviceCity': _cityController.text.trim(),
          'serviceNeighborhood': _neighborhoodController.text.trim(),
          'serviceRadiusKm': 10,
      ...
      setState(() {
        _error = error.message.contains('e-mail')
            ? '${error.message} Tente entrar na aba Login.'
            : error.message;
      });
    } catch (_) {
      setState(() => _error =
          'Não foi possível concluir. Verifique a API e tente novamente.');
    } finally {
            ...
            AnimatedContainer(
              ...
              decoration: BoxDecoration(
                gradient: LinearGradient(
                  colors: _isLogin
                      ? const [Color(0xFF0757B8), Color(0xFF0287D9)]
                      : const [Color(0xFF0757B8), Color(0xFFFF7A00)],
              ...
              child: Column(
                ...
                children: [
                  Text(
                    _isLogin
                        ? 'Entre e peça ajuda em poucos toques.'
                        : 'Crie seu acesso do jeito certo para seu perfil.',
                  ...
                  Text(
                    ...
                    style:
                        const TextStyle(color: Color(0xFFEAF6FF), fontSize: 15),
                  ),
                ],
              ),
            ),
                    ...
                    children: [
                      ...
                      FilledButton(
                        ...
                        child: Text(_isLoading
                            ? 'Aguarde...'
                            : (_isLogin ? 'Entrar' : 'Finalizar cadastro')),
                      ),
                    ],
                  ),
                ),
    ...
    return Column(
      ...
      children: [
        ...
        TextFormField(
          ...
          decoration: const InputDecoration(
              prefixIcon: Icon(Icons.lock_rounded), labelText: 'Senha'),
          obscureText: true,
  ...
  Widget _buildRegisterFields() {
    return Column(
      ...
      crossAxisAlignment: CrossAxisAlignment.stretch,
      children: [
        Text('Você quer usar o app como:',
    ...
    return Column(
      ...
      children: [
        ...
        TextFormField(
          ...
          decoration:
              const InputDecoration(labelText: 'Descrição profissional'),
          minLines: 3,
          maxLines: 5,
        ...
        TextFormField(
            ...
            validator: _userType == 'provider' ? _requiredText : null),
        const SizedBox(height: 12),
        TextFormField(
            controller: _averagePriceController,
            decoration:
                const InputDecoration(labelText: 'Valor médio ou a combinar'),
            validator: _userType == 'provider' ? _requiredText : null),
  ...
  String? _requiredText(String? value) =>
      value == null || value.trim().length < 2 ? 'Informe este campo.' : null;
  String? _longTextValidator(String? value) =>
    ...
    return InkWell(
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          ...
          borderRadius: BorderRadius.circular(16),
          border: Border.all(
              color: selected ? colors.primary : const Color(0xFFD7DEE8),
        ...
        child: Column(
          ...
          children: [
            Icon(icon,
                color: selected ? colors.primary : const Color(0xFF516070)),
            const SizedBox(height: 8),
